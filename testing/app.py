...
# Page configuration
st.set_page_config(
    page_title="NeuralHire - AI Hiring Assistant",
    page_icon="🎯",
    layout="wide",
...
def welcome_page():
    ...
    with col2:
        ...
        <div class="welcome-card">
            ...
            <p><strong></strong> I'm here to conduct your initial technical screening for technology positions at NeuralHire.</p>
        </div>
        """, unsafe_allow_html=True)
